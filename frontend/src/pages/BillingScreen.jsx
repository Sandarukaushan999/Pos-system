...
const BillingScreen = () => {
  ...
  return (
    <>
      ...
      {/* Receipt Modal rendered at the end, always on top */}
      {showReceiptModal && printData && printData.items && printData.items.length > 0 && (
        <div style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.5)', zIndex: 99999, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 16 }}>
          <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-6 relative">
            <button
              ...
              className="absolute top-2 right-2 w-8 h-8 rounded-lg bg-gray-200 hover:bg-gray-300 flex items-center justify-center"
            >
